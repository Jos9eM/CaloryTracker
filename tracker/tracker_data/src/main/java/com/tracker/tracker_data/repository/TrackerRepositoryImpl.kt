package com.tracker.tracker_data.repository

import com.tracker.tracker_data.local.TrackerDao
import com.tracker.tracker_data.mapper.toTrackableFood
import com.tracker.tracker_data.mapper.toTrackedFood
import com.tracker.tracker_data.mapper.toTrackedFoodEntity
import com.tracker.tracker_data.remote.OpenFoodApi
import com.tracker.tracker_domain.model.TrackableFood
    ...
    override suspend fun searchFood(
        ...
        return try {
            ...
            Result.success(searchDto.products.filter {
                ...
                val lowerBound = calculatedCal * 0.99f
                val upperBound = calculatedCal * 1.01f
