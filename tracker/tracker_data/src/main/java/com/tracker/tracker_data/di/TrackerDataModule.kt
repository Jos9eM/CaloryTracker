package com.tracker.tracker_data.di

import android.app.Application
import androidx.room.Room
import com.tracker.tracker_data.local.TrackerDatabase
import com.tracker.tracker_data.remote.OpenFoodApi
import com.tracker.tracker_data.repository.TrackerRepositoryImpl
...
object TrackerDataModule {
    ...
    fun provideTrackerDatabase(app: Application): TrackerDatabase {
        return Room.databaseBuilder(
            app, TrackerDatabase::class.java, "tracker_db"
        ).build()
    }
