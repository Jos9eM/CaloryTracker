package com.onboarding.onboarding_presentation.nutrient_goal
...
fun NutrientGoalScreen(
    ...
    Box(
        ...
        Column(
            ...
            UnitTextField(
                value = viewModel.state.carbsRatio, onValueChange = {
            ...
            Spacer(modifier = Modifier.height(spacing.spaceMedium))
            UnitTextField(
                value = viewModel.state.proteinRatio, onValueChange = {
            ...
            Spacer(modifier = Modifier.height(spacing.spaceMedium))
            UnitTextField(
                value = viewModel.state.fatRatio, onValueChange = {
